//
//  ColorConstraintsTableViewCell.swift
//  MTGPrices
//
...
class ColorConstraintsTableViewCell: UITableViewCell {
    
    var buttons = [DLRadioButton]()
    var choices = ["Match Exactly", "\"AND\" Colors"]
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        for choice in choices {
            buttons.append(createButton(title: choice))
        }
